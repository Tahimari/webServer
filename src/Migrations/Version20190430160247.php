 ...
 */
final class Version20190430160247 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD dark_theme TINYINT(1) NOT NULL, CHANGE roles roles JSON NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP dark_theme, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
    }
}
