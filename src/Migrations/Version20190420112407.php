 ...
 */
final class Version20190420112407 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE delivery ADD type_of_delivery VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
